 ...
 *
 * Этот метод является pass-through (метод-прослойка) для соблюдения принципа единой точки входа.
 * Контроллер всегда работает через сервис, даже если сейчас нет дополнительной логики.
 * В будущем здесь может быть добавлено: кеширование, логирование, проверка прав доступа.
 */
